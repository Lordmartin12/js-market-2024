...
import { getAuthUser } from "../hooks/AuthUser";
...
const AppLayout = () => {
    ...
    return (
        <>
        {/* Use the Navigate element to redirect to login if there is no user */}
            {(currentUser == null || currentUser == '' || currentUser == undefined) ? (
                <Navigate to={`/login`} />
            ) :
